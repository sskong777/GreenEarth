...
public class RewardController {
    ...
    public ResponseEntity<List<RewardResDto>> getAllRewards(@PathVariable("child_id") int child_id){
    ...
    public ResponseEntity<RewardResDto> createReward(@PathVariable("child_id") int child_id, @RequestBody RewardReqDto rewardReqDto){
    ...
    public ResponseEntity<RewardResDto> updateReward(@PathVariable("reward_id") int reward_id, @RequestBody RewardPutDto rewardPutDto){
    ...
    public ResponseEntity<RewardResDto> paidReward(@PathVariable("reward_id") int reward_id){
