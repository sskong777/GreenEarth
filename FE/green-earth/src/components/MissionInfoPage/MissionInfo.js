...
import { missionInfoState } from "./../../store/atoms";
import { useMissionInfoCallback } from "./../../functions/useMissionInfoCallback";
const MissionInfo = () => {
  ...
  const [missionInfo, setMissionList] = useRecoilState(missionInfoState);

  const { missionInfoCallback } = useMissionInfoCallback();
