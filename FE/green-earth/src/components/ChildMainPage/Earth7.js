...
import {Child1, Child2, Child3, Child4, Child5, Child6, Child7, Child8, Child10, Child15, Child30,
    Child31, Child32, Child33, Child34, Child35, Child36, Child37, Child38, Child39} from "../../Model.js/Child"


import {  Model0,  EarthLv7} from "../../Model.js/Space"
  ...
  return (
    ...
    <div className="Rocket" style={{left:mileage}}>
      ...
      <div className= "infogroup7">
          <div className = "canvasProfile7" onClick={handleClickChildProfile}>
