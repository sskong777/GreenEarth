  ...
  const script = [
    ...
    },
    {
      ...
      data: {
        ...
        contents: "탄소배출로 인한 지구온난화의 영향으로 치타는 멸종위기에 처했어요. 한 가구에서 대기전력을 줄이기 위한 노력을 한다면 연간 82kg 정도의 탄소배출을 줄일 수 있습니다. 106만 세대의 대구시민이 실천한다면 연간 약 8만 7000톤의 온실가스를 감축할 수 있다. 대구시 면적의 8%에 해당하는 30년생 소나무 숲이 연간 흡수하는 탄소량과 같습니다. 사용하지 않는 콘센트를 뽑고 대기전력을 줄여 탄소배출 줄이기에 동참해주세요",
    ...
    },
    {
      ...
      data: {
        ...
        contents: "아프리카 강과 호수, 습지에 사는 하마는 기후위기로 찾아오는 가뭄, 기온상승으로 인해 위기에 빠졌어요. 하마가 출현했던 36개 국가 중 3개국에서는 최근 하마가 멸종했다고 보고됐으며, 20개국에서 개체수가 감소하고 7개국에는 개체수에 관한 정보조차 없어요. 길에 버려진 쓰레기는 강이나 바다로 흘러들어가 환경오염의 주범이 됩니다. 길에서 쓰레기를 주워서 환경 지키기에 동참해주세요",
