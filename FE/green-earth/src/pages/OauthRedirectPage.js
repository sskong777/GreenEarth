  ...
  return (
    <div className="w-full h-full flex flex-col justify-between items-center">
      ...
      <img
        ...
        className="w-188 mt-28 animate-pulse"
      />
      <div
      ...
      >
        <svg
          aria-hidden="true"
          className="mr-2 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-[#FEE500]"
          viewBox="0 0 100 101"
          fill="none"
        ...
        <div className="text-[#FEE500] text-4xl ">
          카카오 계정으로 로그인 중 입니다...
        </div>
      </div>
